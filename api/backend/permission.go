...
type PermissionReq struct {
	g.Meta `path:"/permission/add" method:"post" desc:"添加权限" tags:"权限" summary:"添加权限"`
...
type PermissionUpdateReq struct {
	g.Meta `path:"/permission/update" method:"post" desc:"修改权限" tags:"权限" summary:"更新权限信息"`
...
type PermissionDeleteReq struct {
	...
	Id     uint `v:"required|min:1#请选择需要删除的权限" dc:"权限id"`
}
