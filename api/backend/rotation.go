...
type RotationReq struct {
	g.Meta `path:"/rotation/add" tags:"轮播图" method:"post" summary:"添加轮播图接口"`
...
type RotationDeleteReq struct {
	...
	Id     uint `v:"required|min:1#请选择需要删除的轮播图" dc:"轮播图id"`
}
...
type RotationGetListCommonReq struct {
	g.Meta `path:"/rotation/list" method:"get" tags:"轮播图" summary:"后端轮播图列表接口"`
